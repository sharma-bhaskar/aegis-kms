...
/** SPI for policy evaluation. The default implementation is an allowlist
  * matcher over role bindings. Alternate implementations could wrap OPA /
  * Rego or a policy language hosted elsewhere.
  */
