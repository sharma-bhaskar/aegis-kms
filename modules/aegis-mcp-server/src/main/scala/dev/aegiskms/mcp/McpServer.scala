...
/** Aegis-KMS MCP server. Exposes KMS operations as Model Context Protocol
  * tools so Claude and other MCP-speaking LLMs can act as operators (within
  * the scope of a `Principal.Agent`).
  *
